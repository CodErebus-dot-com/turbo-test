...
import { IGraphserviceappDetailMapper } from '../services/graphserviceapp/mappers'
...
export type GraphserviceappDetail = {
  __typename?: 'GraphserviceappDetail'
  partyId: Scalars['ID']
...
export type Query = {
  ...
  timeAtGraphserviceapp: Scalars['GraphQLDateTime']
  /** Get details of graphserviceapp including list of graphserviceapp status */
  graphserviceappDetail: GraphserviceappDetail
}
...
export type ResolversTypes = ResolversObject<{
  GraphserviceappDetail: ResolverTypeWrapper<IGraphserviceappDetailMapper>
...
export type ResolversParentTypes = ResolversObject<{
  GraphserviceappDetail: IGraphserviceappDetailMapper
  ID: Scalars['ID']
...
export type costDirectiveResolver<
  Result,
  Parent,
  ContextType = ICommonContextType,
  Args = costDirectiveArgs,
> = DirectiveResolverFn<Result, Parent, ContextType, Args>

export type GraphserviceappDetailResolvers<
  ContextType = ICommonContextType,
  ParentType extends ResolversParentTypes['GraphserviceappDetail'] = ResolversParentTypes['GraphserviceappDetail'],
> = ResolversObject<{
  __resolveReference?: ReferenceResolver<
    Maybe<ResolversTypes['GraphserviceappDetail']>,
    { __typename: 'GraphserviceappDetail' } & GraphQLRecursivePick<ParentType, { partyId: true }>,
    ContextType
  >
...
export type GenderEnumResolvers = EnumResolverSignature<
   { MALE?: string; FEMALE?: string; NON_BINARY?: string; UNSPECIFIED?: string },
  ResolversTypes['GenderEnum']
>
...
export type NameDetailsResolvers<
  ContextType = ICommonContextType,
  ParentType extends ResolversParentTypes['NameDetails'] = ResolversParentTypes['NameDetails'],
> = ResolversObject<{
...
> = ResolversObject<{
  timeAtGraphserviceapp?: Resolver<ResolversTypes['GraphQLDateTime'], ParentType, ContextType>
  graphserviceappDetail?: Resolver<ResolversTypes['GraphserviceappDetail'], ParentType, ContextType>
}>

export type Resolvers<ContextType = ICommonContextType> = ResolversObject<{
  GraphserviceappDetail?: GraphserviceappDetailResolvers<ContextType>
