...
import { IGraph2DetailMapper } from '../services/graph2/mappers'
...
export type Graph2Detail = {
  __typename?: 'Graph2Detail'
  partyId: Scalars['ID']
...
export type Query = {
  ...
  timeAtGraph2: Scalars['GraphQLDateTime']
  /** Get details of graph2 including list of graph2 status */
  graph2Detail: Graph2Detail
}
...
export type ResolversTypes = ResolversObject<{
  Graph2Detail: ResolverTypeWrapper<IGraph2DetailMapper>
...
export type ResolversParentTypes = ResolversObject<{
  Graph2Detail: IGraph2DetailMapper
  ID: Scalars['ID']
...
export type Graph2DetailResolvers<
  ContextType = ICommonContextType,
  ParentType extends ResolversParentTypes['Graph2Detail'] = ResolversParentTypes['Graph2Detail'],
> = ResolversObject<{
  __resolveReference?: ReferenceResolver<
    Maybe<ResolversTypes['Graph2Detail']>,
    { __typename: 'Graph2Detail' } & GraphQLRecursivePick<ParentType, { partyId: true }>,
    ContextType
  >
...
> = ResolversObject<{
  timeAtGraph2?: Resolver<ResolversTypes['GraphQLDateTime'], ParentType, ContextType>
  graph2Detail?: Resolver<ResolversTypes['Graph2Detail'], ParentType, ContextType>
}>

export type Resolvers<ContextType = ICommonContextType> = ResolversObject<{
  Graph2Detail?: Graph2DetailResolvers<ContextType>
